...
class PsychologistsViewModel : ViewModel() {
    ...
    fun initialQuery(): Query {
        ...
        _listQuery.value = userRepository.buildPsychologistsListQuery(userId)
    ...
    fun addPsychologist(email: String) {
        viewModelScope.launch {
            userRepository.addPsychologist(email)
        }
    }

    fun removePsychologist(id: String) {
        viewModelScope.launch {
            userRepository.removePsychologist(id)
        }
    }
}